...
import Booking from './pages/booking_pages/Booking';
import Payment from './pages/booking_pages/Payment';
import TrainInfo from './pages/home_pages/TrainInfo';
import PnrStatus from './pages/home_pages/PnrStatus';
import BookingList from './pages/home_pages/BookingList';
import Search from './pages/home_pages/Search';
