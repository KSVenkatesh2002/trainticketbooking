...
const Payment = lazy(() => import("./pages/booking_pages/payment/Payment"));
...
// routing
const BookingRouter = lazy(() => import("./component/router/BookingRouter"));
const HomeRouter = lazy(() => import("./component/router/HomeRouter"));
const PrivateRouter = lazy(() => import("./component/router/PrivateRouter"));
