...
//
    return (
        <div className="flex flex-col items-center w-full min-h-[calc(100vh-8vh)] h-fit bg-gray-900 text-white">
            <div className='w-full min-h-[8vh] flex justify-evenly items-center bg-gray-800 shadow-lg shadow-black/50'>
