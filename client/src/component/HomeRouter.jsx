...
//
    return (
        <div className="flex flex-col items-center h-full min-h-screen w-full">
            ...
            <div className='w-full min-h-[50px] py-4 flex justify-evenly items-center bg-gray-600 shadow-lg shadow-black/50'>
                <div className={`flex justify-evenly items-center  p-1 h-9/10 rounded-2xl w-1/5 text-center hover:underline ${nav==='search' && 'shadow-sm shadow-black' }`}>
                ...
                <div className={`flex justify-evenly items-center  p-1 h-9/10 rounded-2xl w-1/5 text-center hover:underline ${nav==='pnr-status' && 'shadow-sm shadow-black' }`}>
                ...
                <div className={`flex justify-evenly items-center  p-1 h-9/10 rounded-2xl w-1/5 text-center hover:underline ${nav==='train-info' && 'shadow-sm shadow-black' }`}>
                ...
                <div className={`flex justify-evenly items-center  p-1 h-9/10 rounded-2xl w-1/5 text-center hover:underline ${nav==='my-booking' && 'shadow-sm shadow-black' }`}>
